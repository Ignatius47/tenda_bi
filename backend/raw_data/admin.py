...
from .models import RawOrder, RawProduct, RawCustomer, RawInventoryLevel, SyncLog
...
class SyncLogAdmin(admin.ModelAdmin):
    list_display = ['store', 'sync_type', 'status', 'orders_synced', 'products_synced', 'customers_synced', 'started_at', 'finished_at']
